...
import TagTable from "../modules/Tags/TagTable";
import {
  getFiltersFromUrl,
...
function Tags(props) {
  ...
  useEffect(() => {
    ...
    fetch(env.siteApi + "/panel/product/list-tags", postOptions)
      .then((res) => res.json())
      .then(
        (result) => {
          setLoading(0);
      ...
      <div className="list-container">
        ...
        <div className="user-list">
          {loading ? (
            ...
            <TagTable setLoading={setLoading} brand={content} 
